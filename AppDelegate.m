...
//  sqliteDemo_SPT
//
//  Created by GadgetZone on 4/18/18.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    NSString *staffPath=[libraryPath stringByAppendingPathComponent:@"staffDB.sqlite"];
    NSString *staffbundlepath=[[NSBundle mainBundle]pathForResource:@"staffDB" ofType:@"sqlite"];
